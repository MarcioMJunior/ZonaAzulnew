				...
				<div class="painel-controle">
					<div class="panel panel-primary">
						<div class="panel-heading">
							Recarga para usuario
						</div>
						<div class="panel-body">
							<div class="controle-form">
								<form action="recargausuarioconf.php" method="post">
									...
									<div class="row">
										...
										<div class="col-md-6">
											Valor da recarga: <div class="clearmin"></div>
											<input type="text" name="recarga" class="form-control">
										</div>
									</div>	
									<div class="clear"></div>
									<div align="right">
										<input type="submit" class="btn btn-primary" value="Realizar recarga">
									</div>
								</form>
							</div>
						</div>
