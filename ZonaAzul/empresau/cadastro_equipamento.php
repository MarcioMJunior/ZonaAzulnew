					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="controle-form">
								<form action="cadastroequipamentoconf.php" method="post">
									<input type="hidden" name="idUnidade" value="<?php echo $id;?>">
									<div class="row">
										<div class="col-md-6">
											Identificação equipamento: <div class="clearmin"></div>
											<input type="text" name="id" class="form-control">
										</div>
										<div class="col-md-6">
											TIPO: <div class="clearmin"></div>
								...
								<div class="table-responsive">
									<table border="1" class="table table-hover">
										...
										<tbody>
											<?php
												$consulta = "SELECT * FROM `equipamentos_unidade` WHERE `ID_UNIDADE` = '$id'";
